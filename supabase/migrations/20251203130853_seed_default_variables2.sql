-- Delete the existing default variable data
DELETE FROM document_default_variables 
WHERE category IN (
    'GLOBAL',
    'ARCHITECTURE',
    'CONSTRUCTION',
...
-- Insert new default variable data
...
VALUES
  ...
  (
    ...
    '[
      {
        "id": "f01-national-fire-code",
        "name": "National Fire Code",
        "type": "dropdown",
        "description": "Applied national fire code for the project",
        "dropdownOptions": [
  ...
  (
    'HVAC',
    'HVAC1 System Specification',
    'HVAC equipment sizing and operating parameters',
    '[
      {
        "id": "hvac1-hvac-airflow",
        "name": "Airflow",
        "type": "number",
        "description": ""
      }
  ...
  (
    'EXECUTION CONTROL',
    'EXE1 Execution Inspection',
    'On-site inspection and sign-off criteria',
    '[
      {
        "id": "exe1-inspection-date",
