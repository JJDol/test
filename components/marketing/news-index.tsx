  ...
  return (
    <MarketingPageShell>
      <main className="mx-auto w-full max-w-[1760px] px-5 py-16 md:px-8 md:py-24 lg:px-10">
        ...
        <h1 className={`${instrumentSerif.className} mt-4 text-5xl leading-[1.08] md:text-7xl`}>News</h1>
            ...
            <li key={article.slug} className="border-b border-[#1a1a1a]/12">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h2 className="mt-1 text-[18px] font-medium leading-snug tracking-tight group-hover:underline md:text-[22px]">
                    {article.title}
                  </h2>
                  <p className="mt-2 line-clamp-2 text-[15px] leading-relaxed text-[#1a1a1a]/60">
                    {article.preview}
                  </p>
                </div>
              </Link>
