  ...
  return (
    <MarketingPageShell>
      <main className="mx-auto w-full max-w-[1760px] px-5 py-16 md:px-8 md:py-24 lg:px-10">
        ...
        <p className="mt-6 max-w-[720px] text-[17px] leading-[24.375px] tracking-[-1px] text-[#1a1a1a]/70">
        ...
        <div className="mt-10 max-w-[880px] rounded-xl border border-[#1a1a1a]/10 bg-[#E8E2D6] px-6 py-5 md:px-8">
          <p className={`${marketingMono.className} text-[11px] leading-5 text-[#1a1a1a]/45`}>
            IN PROGRESS
          </p>
          <p className="mt-1 text-[22px] font-medium leading-[30px] tracking-[-1.76px]">
            Tutorials are currently in production.
          </p>
          <p className="mt-2 text-[15px] leading-[24.375px] tracking-[-0.6px] text-[#1a1a1a]/65">
        ...
        <section className="mt-16">
          <div className="flex items-end justify-between gap-6 border-b border-[#1a1a1a]/15 pb-4">
          ...
          <div className="grid gap-10 pt-8 md:grid-cols-3 md:gap-8 lg:gap-12">
            {TUTORIALS.map((tutorial, index) => (
              <article key={tutorial.title}>
                <div className="flex aspect-video items-center justify-center rounded-xl border border-[#1a1a1a]/10 bg-[#E8E2D6]">
                  <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[#202306] text-white">
                    <Play className="ml-0.5 h-5 w-5" fill="currentColor" aria-hidden />
                  </span>
                </div>
                <p className={`${marketingMono.className} mt-5 text-[11px] leading-5 text-[#1a1a1a]/45`}>
                  TUTORIAL {String(index + 1).padStart(2, "0")}
                </p>
                <h3 className="mt-1 text-[22px] font-medium leading-[30px] tracking-[-1.76px]">
                  {tutorial.title}
                </h3>
                <p className="mt-2 text-[15px] leading-[24.375px] tracking-[-0.6px] text-[#1a1a1a]/60">
            ...
            {MATERIALS.map((material) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-[15px] leading-[24.375px] tracking-[-0.6px] text-[#1a1a1a]/60">
                    {material.description}
                  </p>
                </div>
                <span className={`${marketingMono.className} shrink-0 text-[11px] leading-5 text-[#1a1a1a]/45`}>
                  COMING SOON
                </span>
              </li>
            ))}
