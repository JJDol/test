...
export function MarketingHomepage() {
  return (
    <div className={`${marketingSans.className} bg-[#F5F2EB] text-[#202326]`}>
      <div className="relative min-h-svh">
        ...
        <section className="relative isolate h-svh overflow-hidden bg-[#F5F2EB]">
          ...
          <Link
            href="#how-it-works"
            className="absolute bottom-[5%] left-[4%] z-20 flex h-11 w-[254px] items-center justify-center rounded-[12px] bg-[#202326] text-[14px] font-medium leading-5 tracking-[1.12px] text-white"
          >
            VIEW PRODUCT TOUR
          </Link>
        </section>
