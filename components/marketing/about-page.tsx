...
import { marketingMono, marketingTitleDisplay, marketingTitleSection } from "@/lib/marketing/fonts";

export function AboutPage() {
  return (
    <MarketingPageShell>
      <main className="mx-auto w-full max-w-[1760px] px-5 py-16 md:px-8 md:py-24 lg:px-10">
        <p className={`${marketingMono.className} text-[12px] leading-5 text-[#202326]/45`}>About us</p>
        <h1 className={`mt-4 max-w-[920px] ${marketingTitleDisplay}`}>
          ATI:lab builds AutoDoc for the way projects actually run.
        </h1>
        <p className="mt-8 max-w-[640px] text-[17px] leading-[24.375px] tracking-[-1px] text-[#202326]/75">
