  ...
  return (
    <MarketingPageShell>
      <main className="mx-auto w-full max-w-[1760px] px-5 py-16 md:px-8 md:py-24 lg:px-10">
        ...
        <p className="mt-6 max-w-[760px] text-[17px] leading-[24.375px] tracking-[-1px] text-[#1a1a1a]/70">
          Discover how AutoDoc brings project information, company knowledge, and collaboration
          into one consistent document workflow.
        </p>

        <div className="mt-20 border-t border-[#1a1a1a]/15">
          {MARKETING_FEATURES.map((feature, index) => (
            <section
              id={feature.id}
              key={feature.title}
              className="grid scroll-mt-24 gap-8 border-b border-[#1a1a1a]/15 py-14 md:grid-cols-2 md:items-center md:gap-14 md:py-20 lg:gap-24"
            >
              <img
                src={feature.image}
                alt=""
              ...
              <div>
                <p
                  className={`${marketingMono.className} text-[11px] leading-5 text-[#1a1a1a]/45`}
                >
                ...
                <p className="mt-6 max-w-[640px] text-[17px] leading-[26px] tracking-[-1px] text-[#1a1a1a]/80">
                  {feature.short}
                </p>
              </div>
            </section>
