...
//TODO: Figure out what is this good for, it seems similar to chat/route.ts
// TODO: Here can we get rid of it?
async function enhancedSearchHandler(request: AuthenticatedRequest) {
  try {
...
export const GET = withAuth(enhancedSearchHandler); 